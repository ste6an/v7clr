...
public:
	DWORD m_ID;
	char* m_str1; //+ e.g. "ReportContainer"
	char* m_str2; //+ e.g. "Report"
	char* m_str3; //+ e.g. "Report"
	//+	CDocument* m_pDoc;
	CTypedDataCont* m_pDoc;
...
public:
	...
	// FD2007
	// используется как GetDocument(CConfigCont::DocID)
